...
const GitHubActivity = ({ className = "" }: GitHubActivityProps) => {
  ...
  if (
    ...
    return (
      <Card
        className={`p-6 border-primary/20 bg-gradient-to-r from-primary/5 to-primary-glow/5 ${className}`}
      >
        ...
        <div className="text-center py-8 px-4">
          ...
          <p className="text-sm font-medium text-foreground mb-2">
            GitHub API Temporarily Limited
          </p>
          <p className="text-xs text-muted-foreground mb-4 max-w-sm mx-auto leading-relaxed">
            GitHub's public API has rate limiting. Your GitHub stats will be
            displayed once the limit resets. Please try again in a few minutes
            or{" "}
            <a
  ...
  return (
    <Card
      className={`border-primary/20 bg-gradient-to-r from-primary/5 to-primary-glow/5 ${className}`}
    >
      {/* GitHub Header */}
      <div className="p-6">
        <div className="flex items-center justify-between mb-4">
