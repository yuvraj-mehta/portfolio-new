        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              {personalInfo.tagline} • Academic foundation and continuous
              learning
            </p>
          </motion.div>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4 mb-4">
                            ...
                            <div className="flex items-center justify-between sm:justify-end gap-2 flex-shrink-0">
                              ...
                              >
                                <Badge
                                  variant="outline"
                                  className="text-primary border-primary/40 text-xs whitespace-nowrap flex items-center gap-1"
                                >
                              ...
                              <motion.div
                                animate={{
                                  color: expandedCards.includes(entry.id)
                                    ? "hsl(var(--primary))"
                                ...
                                >
                                  ...
                                  <div>
                                    ...
                                    <motion.ul
                                      ...
                                      animate="visible"
                                    >
                                      {entry.keyPoints.achievements.map(
                                        (achievement, idx) => (
                                          <motion.li
                                            key={idx}
                                            className="text-xs sm:text-sm text-muted-foreground flex items-start"
                                ...
                                {entry.keyPoints.activities && (
                                  ...
                                  >
                                    ...
                                    <motion.div
                                      ...
                                      animate="visible"
                                    >
                                      {entry.keyPoints.activities.map(
                                        (activity, idx) => (
                                          <motion.div
                                            key={idx}
